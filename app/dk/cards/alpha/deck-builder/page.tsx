...
// DK shell — same data + same UI. UI strings stay English per AFS-26.
export const metadata: Metadata = {
  title: 'Alpha Deck Builder — voidexa',
  description:
    'Byg dit 60-korts voidexa Alpha-deck. Træk kort op, klik for at fjerne, gem op til 5 decks per pilot. UI på engelsk pr. AFS-26.',
  alternates: {
    canonical: '/dk/cards/alpha/deck-builder',
    languages: {
...
export default async function AlphaDeckBuilderPageDk() {
