...
function MiniSolarSystem({
  ...
  useEffect(() => {
    ...
    const planets = isMystery
      ? [
          { r: 38, speed: 0.003, size: 4, color: 'rgba(0,212,255,0.4)', phase: 0 },
          { r: 60, speed: 0.0018, size: 5, color: 'rgba(139,92,246,0.4)', phase: 1.2 },
          { r: 82, speed: 0.001, size: 3, color: 'rgba(0,212,255,0.3)', phase: 2.5 },
        ]
      : [
          { r: 38, speed: 0.004, size: 5, color: '#ff6600', phase: 0 },
          { r: 56, speed: 0.0025, size: 4, color: '#cc00ff', phase: 0.8 },
          { r: 74, speed: 0.0015, size: 6, color: '#00ff44', phase: 1.6 },
          { r: 92, speed: 0.0009, size: 3, color: '#ff0044', phase: 2.4 },
        ]
