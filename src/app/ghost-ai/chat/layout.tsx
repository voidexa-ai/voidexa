// src/app/ghost-ai/chat/layout.tsx
// Ghost AI Chat — Layout with sidebar
...
export default async function ChatLayout({
  ...
  if (!user) {
    redirect('/auth/login?redirect=/ghost-ai/chat');
  }
    ...
    <div className="flex h-screen bg-gray-950 text-white">
      ...
      <aside className="w-72 border-r border-gray-800 flex-shrink-0 hidden md:flex flex-col">
        ...
        <div className="p-4 border-b border-gray-800">
          <h2 className="text-lg font-semibold">Ghost AI</h2>
        </div>
