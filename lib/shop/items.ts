...
> = {
  [ShopCategory.ShipSkin]:     { min: 100, max: 2000 }, // Common skin $1-2 → Epic ship $10-20
  [ShopCategory.Attachment]:   { min: 200, max: 500 },  // Attachment $2-5
  [ShopCategory.Effect]:       { min: 500, max: 1000 }, // Premium effect $5-10
  [ShopCategory.Trail]:        { min: 300, max: 1500 }, // custom band — sits between effects/skins
  [ShopCategory.CockpitTheme]: { min: 500, max: 1500 }, // custom band
  [ShopCategory.Emote]:        { min: 100, max: 500 },  // small cosmetic
  [ShopCategory.CardPack]:     { min: 200, max: 2000 }, // Card packs $2-$20 (Part 8)
};
