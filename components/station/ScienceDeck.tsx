...
const ROADMAP: RoadmapItem[] = [
  ...
  },
  {
    ...
    desc: 'AI secretary for scheduling. Flutter app built, awaiting test.',
    tooltip: 'AI secretary for scheduling, follow-ups, and communications. Flutter app built, awaiting test.',
    status: 'testing',
    phase: 'Phase 10',
  },
  {
    title: 'BOSSO',
    desc: 'Encrypted P2P lending tracker. Flutter app built, awaiting test.',
    tooltip: 'Encrypted P2P lending tracker and autonomous business operations AI. Flutter app built, awaiting test.',
    status: 'testing',
    phase: 'Phase 11',
  },
  {
  ...
  {
    title: 'Comlink',
    desc: 'Encrypted messaging. Rebuilt v10.0, awaiting test.',
