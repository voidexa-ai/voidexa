...
const RESPONSES: Record<string, { text: string; nav?: string }> = {
  ...
  trading:  { text: "The All-Season Bot is our flagship — a fully autonomous crypto rebalancer with market regime detection. 4 phases, 5-stage pipeline, +357% backtested. Want me to take you there?", nav: '/trading' },
  bot:      { text: "The trading bot classifies market conditions (BTC/ETH/ALTCOIN phases + RISK_OFF), generates allocation proposals, passes them through a risk gate, then executes. Backtested +357% over 12 months vs buy-and-hold -6%.", nav: '/trading' },
